...
const LobbyScene =()=> {
    ...
    const navs: NavProps[] = [
        {id: 1, name: '今日爆款', image: themeContext.IMAGES.NAVS_JRBK},
        {id: 2, name: '机票酒店', image: themeContext.IMAGES.NAVS_JPJD},
        {id: 3, name: '天猫国际', image: themeContext.IMAGES.NAVS_TMGJ},
        {id: 5, name: '金币庄园', image: themeContext.IMAGES.NAVS_JPZY},
        {id: 4, name: '海外集运', image: themeContext.IMAGES.NAVS_HWJY},
        {id: 6, name: '阿里拍卖', image: themeContext.IMAGES.NAVS_ALPM},
        {id: 7, name: '天猫超市', image: themeContext.IMAGES.NAVS_TMCS},
        {id: 8, name: '淘宝吃货', image: themeContext.IMAGES.NAVS_TBCH},
        {id: 9, name: '分类', image: themeContext.IMAGES.NAVS_FL},
        {id: 10, name: '闲鱼', image: themeContext.IMAGES.NAVS_XY},
        {id: 11, name: '天猫美食', image: themeContext.IMAGES.NAVS_TMMS},
        {id: 12, name: '会员中心', image: themeContext.IMAGES.NAVS_HYZX},
        {id: 13, name: '阿里健康', image: themeContext.IMAGES.NAVS_ALJK},
        {id: 14, name: '造点新货', image: themeContext.IMAGES.NAVS_ZDXH},
        {id: 15, name: '口碑生活', image: themeContext.IMAGES.NAVS_KPSH},
        {id: 16, name: '土货鲜食', image: themeContext.IMAGES.NAVS_THXS},
    ];
